...
validators = {
    ('dentists', 'POST'): {'json': {'required': ['name', 'location', 'specialisation'], 'type': 'object', 'properties': {'specialisation': {'type': 'string'}, 'name': {'type': 'string'}, 'location': {'type': 'string'}}}},
}

filters = {
    ('dentists_id', 'GET'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
    ('dentists_id', 'DELETE'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': None}, 404: {'headers': None, 'schema': None}},
    ('dentists', 'POST'): {200: {'headers': None, 'schema': None}, 405: {'headers': None, 'schema': None}},
